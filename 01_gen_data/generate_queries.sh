...
echo "$PWD/dsqgen -input $PWD/query_templates/templates.lst -directory $PWD/query_templates -dialect greenplum -scale $GEN_DATA_SCALE -verbose y -output $PWD"
$PWD/dsqgen -input $PWD/query_templates/templates.lst -directory $PWD/query_templates -dialect greenplum -scale $GEN_DATA_SCALE -verbose y -output $PWD
